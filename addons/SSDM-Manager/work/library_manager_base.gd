...
func add_disk_resource(resource_reference: SSDMResourceReference) -> SSDMResult:
...
func rename_disk_resource(new_name: String, resource_reference: SSDMResourceReference) -> SSDMResult:
...
func delete_disk_resource(resource_reference: SSDMResourceReference) -> SSDMResult:
